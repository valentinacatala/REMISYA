...
namespace REMISYA
{
    public partial class PRINCIPAL : Form
    {
        ...
        private void eJEMPLO4ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form4 f4 = new Form4();
            f4.ShowDialog();
        ...
        private void eJEMPLO6ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form6 f6 = new Form6();
            f6.ShowDialog();
        ...
        private void eJEMPLO8ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form8 f8 = new Form8();
            f8.ShowDialog();
        ...
        private void eJEMPLO9ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form9 f9 = new Form9();
            f9.ShowDialog();
        ...
        private void eJEMPLO10ToolStripMenuItem_Click(object sender, EventArgs e)
        {
